...
extern void TimSpesificIrqHandler(void);
extern void TrigIrqHandlr(void);
extern void IrqHandlerForReceiving(void);
extern void I2C_HandlerForReceiving(void);
...
{
  //IS THERE CLEAR FLAG FOR GPIO(EXTI)?
  TrigIrqHandlr();
}
